...
public final class LocaleContract {
     ...
     * 菲律宾语
     */
    private static volatile Locale sFilipinoLocale;

    public static Locale getFilipinoLocale() {
        if (sFilipinoLocale == null) {
            sFilipinoLocale = new Locale("phi");
        }
        return sFilipinoLocale;
    }

    /**
     * 缅甸语
     */
    private static volatile Locale sBurmeseLocale;

    public static Locale getBurmeseLocale() {
        if (sBurmeseLocale == null) {
            sBurmeseLocale = new Locale("my");
        }
        return sBurmeseLocale;
    }
}